// From: https://github.com/frewsxcv/bevy-web-resizer/blob/main/src/lib.rs
// TODO: When the next version of Bevy is released, this can be removed.
// Can also remove `crossbeam_channel` and `wasm_bindgen`.
use bevy::log;
use bevy::prelude::*;
...
impl bevy::app::Plugin for ResizePlugin {
    fn build(&self, app: &mut App) {
        app.add_system(web_resize_system);
    }
}

fn web_resize_system(winit_windows: NonSend<WinitWindows>, web_resizing: Local<WinitWebResizing>) {
